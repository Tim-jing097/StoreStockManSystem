...
{
    public partial class ModifyAdimi : Form
    {
        private string names;
        public ModifyAdimi(string s)
        {
            this.names = s;
            InitializeComponent();
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            if (Check())
            {
                try
                {
                    ...
                    string sql = "update admin set name='"+name+"',username='"+username+"',pwd='"+pwd+"',id='"+id+"'where name ='"+names+"'";
